...
def main():
    ...
    for action in actions:
        ...
        from_stack = stacks[action.from_val]
        sub_stack = from_stack[len(from_stack) - action.amount:]
        stacks[action.from_val] = from_stack[:len(from_stack) - action.amount]
        print(sub_stack)

        to_stack = stacks[action.to_val]
        stacks[action.to_val] = to_stack + sub_stack
