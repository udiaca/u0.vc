    ...
    for round in range(20):
        for monkey_idx, monkey in enumerate(monkeys):
            ...
            while not monkey["items"].empty():
                ...
                print(f"    Worry level {monkey['raw_operation']} is now {new_item_worry}")
                new_item_worry = new_item_worry // 3
                print(
                    f"    Worry level is divided by 3 to {new_item_worry}"
                )
                ...
                print(f"    Item with worry {new_item_worry} is thrown to monkey {new_monkey}")
